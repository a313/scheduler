...
_Student _$StudentFromJson(Map<String, dynamic> json) => _Student(
  ...
  beginStudy: const DateTimeConverter().fromJson(
    (json['beginStudy'] as num).toInt(),
  ),
  isFollow: const BoolConverter().fromJson((json['isFollow'] as num).toInt()),
  isSpecial: const BoolConverter().fromJson((json['isSpecial'] as num).toInt()),
