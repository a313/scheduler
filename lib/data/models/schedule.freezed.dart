...
mixin _$Schedule {
 ...
 int? get id; set id(int? value); String get name; set name(String value);@TimeOfDayConverter() TimeOfDay get begin;@TimeOfDayConverter() set begin(TimeOfDay value);@TimeOfDayConverter() TimeOfDay get end;@TimeOfDayConverter() set end(TimeOfDay value);
...
@useResult
$Res call({
 int? id, String name,@TimeOfDayConverter() TimeOfDay begin,@TimeOfDayConverter() TimeOfDay end
});
...
/// Create a copy of Schedule
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? begin = null,Object? end = null,}) {
...
class _Schedule extends Schedule {
   _Schedule({this.id, required this.name, @TimeOfDayConverter() required this.begin, @TimeOfDayConverter() required this.end}): super._();
...
/// Create a copy of Schedule
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? begin = null,Object? end = null,}) {
